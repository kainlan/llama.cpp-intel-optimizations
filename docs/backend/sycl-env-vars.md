...
| `GGML_SYCL_BLOCK_EXEC_DENSE_MAX_ARENA_MB=<n>` | 1024 | Largest per-device arena the dense executor may allocate for crossing tensors; a larger plan is declined with `gate=arena-too-large`. |
