...
static ggml_sycl::mem_handle ggml_sycl_element_copy_handle_for_raw_ptr(
...
static void ggml_sycl_element_debug_read_f32(sycl::queue & queue,
    ...
    ggml_sycl::mem_handle src_handle = ggml_sycl_element_copy_handle_for_raw_ptr(const_cast<float *>(src), device, count * sizeof(float));
