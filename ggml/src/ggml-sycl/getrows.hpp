...
// llama.cpp-go37: pure index math used by k_get_rows_q8_0_aos_v2
...
static inline void q8_0_aos_v2_block_index(int64_t i00, int & ib, int & iqs) {
    ib  = static_cast<int>(i00 / QK8_0);
    iqs = static_cast<int>(i00 % QK8_0);
}

static inline bool q8_0_aos_v2_row_out_of_range(int64_t i01, int64_t ne01) {
