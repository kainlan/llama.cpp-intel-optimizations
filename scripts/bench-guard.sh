...
# --log, the verdict plus the same pci=/card= identification is printed to
# stderr. Either way bench-guard's own exit code always mirrors the wrapped
# command's, never the verdict.
#
