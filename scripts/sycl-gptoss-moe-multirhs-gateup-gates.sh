...
PARSER_CANDIDATE=(
    --require-mxfp4-tg-path multirhs-gateup
...
run_correctness_case() {
    ...
    local envs=("ONEAPI_DEVICE_SELECTOR=${DEVICE_SELECTOR}" "GGML_SYCL_MOE_GATEUP_MULTIRHS=1")
...
run_bench_case candidate_multirhs 1 "GGML_SYCL_MOE_GATEUP_MULTIRHS=1"
