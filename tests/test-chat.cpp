...
static void test_template_generation_prompt() {
...

    {
        ...
        check(tmpls, basic(),                  "<|start|>assistant");
        {
            ...
            // field became a vector in the upstream b10630 json/chat migration
            assert_equals(size_t(1), params.thinking_end_tags.size());
            assert_equals(std::string("<|channel|>final<|message|>"), params.thinking_end_tags[0]);
        }
