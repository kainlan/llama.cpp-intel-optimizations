...
using exec_extract_allocs_fn = ggml_sycl_execution_result (*)(ggml_sycl_exec_drain_ticket *, uint32_t *);
using exec_finish_drain_fn = ggml_sycl_execution_result (*)(ggml_sycl_exec_drain_ticket);
