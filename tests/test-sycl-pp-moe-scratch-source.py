...
checks = {
    ...
    "runtime slot state tracks generations": "std::vector<uint64_t>    generations;" in sycl_cpp,
    ...
    "slot owners retained to done event": "retain_handles_until_event(std::move(pp_moe_slot_owners), prompt_down_dispatch_done)" in sycl_cpp,
