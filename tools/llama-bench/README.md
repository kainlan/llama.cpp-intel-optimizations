...
test parameters:
  ...
  -fitt, --fit-target <MiB>                 fit model to device memory with this margin per device in MiB (default: off; ignored by SYCL unified cache builds)
  -fitc, --fit-ctx <n>                      minimum ctx size for --fit-target (default: 4096; ignored by SYCL unified cache builds)
